...
func CollaborationPost(ctx *context.Context) {
	...
	admin_model.CreatePermissionNotice("%s added user %s to %s/%s", ctx.Doer.GetDisplayName(), name, ctx.Repo.Owner.Name, ctx.Repo.Repository.Name)
...
func DeleteCollaboration(ctx *context.Context) {
	...
	admin_model.CreatePermissionNotice("%s removed user %s from %s/%s", ctx.Doer.GetDisplayName(), u.Name, ctx.Repo.Owner.Name, ctx.Repo.Repository.Name)
...
func AddTeamPost(ctx *context.Context) {
	...
	admin_model.CreatePermissionNotice("%s added team %s to %s/%s", ctx.Doer.GetDisplayName(), name, ctx.Repo.Owner.Name, ctx.Repo.Repository.Name)
...
func DeleteTeam(ctx *context.Context) {
	...
	admin_model.CreatePermissionNotice("%s removed team %s from %s/%s", ctx.Doer.GetDisplayName(), team.Name, ctx.Repo.Owner.Name, ctx.Repo.Repository.Name)

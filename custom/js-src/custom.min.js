...
function reportGenerator() {
  ...
  loadResource('https://cdn.jsdelivr.net/npm/vue@3/dist/vue.global.prod.js', () => {
    ...
    const columns = [
      ...
      {name: 'Creator', sort: true, hidden: true, attributes: {style: 'width:190px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis'}},
      {name: 'Assignee', sort: true, hidden: true, attributes: {style: 'width:190px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis'}},
      {name: 'Repos.#ID', sort: {compare: (a, b) => a.props.content.replace(/<[^>]*>?/gm, '').localeCompare(b.props.content.replace(/<[^>]*>?/gm, ''))}, attributes: {style: 'width:15%;white-space:nowrap;overflow:hidden;text-overflow:ellipsis'}},
      {name: 'Title', sort: true, attributes: {style: 'white-space:nowrap;overflow:hidden;text-overflow:ellipsis'}},
      {name: 'Labels', sort: true, hidden: true, attributes: {style: 'width:150px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis'}},
      {name: 'Status', sort: true, hidden: true, attributes: {style: 'width:80px'}},
      {name: 'Created At', sort: true, hidden: true, attributes: {style: 'width:160px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis'}},
      {name: 'Updated At', sort: true, hidden: true, attributes: {style: 'width:160px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis'}},
      {name: 'PCT', sort: true, hidden: true, attributes: {style: 'width:70px;white-space:nowrap'}},
      {name: 'Due Date', sort: true, hidden: true, attributes: {style: 'width:160px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis'}},
    ];

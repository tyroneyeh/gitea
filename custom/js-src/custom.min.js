      ...
      methods: {
        ...
        async queryReport() {
          ...
          for (const issue of resData) {
            ...
            if ((this.username.length && (this.by === 'assigned_by' && !issue.assignees?.some((a) => a.full_name.startsWith(this.username))) ||
              (this.username.length && this.by === 'created_by' && !issue.user.full_name.startsWith(this.username)) ||
          ...
          if (this.username !== window.userTitle) {

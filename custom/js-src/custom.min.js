        ...
        async queryReport() {
          ...
          for (const issue of resData || []) {
            ...
            if (onlyName) {
              ...
              usersSummaryData[onlyName] = usersSummaryData[onlyName] || {created: 0, assigned: 0, contributed: heatmapData[onlyName] || 0};
              const assigneeNames = issue.assignees?.map((a) => a.full_name) || [];
              for (const assignee of assigneeNames) {
                usersSummaryData[assignee] = usersSummaryData[assignee] || {created: 0, assigned: 0, contributed: heatmapData[assignee] || 0};

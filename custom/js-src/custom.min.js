...
function hiToAssignee(userNames, isAppend) {
  ...
  for (const availableUserElement of availableUserElements) {
    const canChecked = userNames.includes(availableUserElement.querySelector('.gt-ellipsis').title);
    ...
    window.app = createApp({
      ...
      methods: {
        ...
        async queryReport(isNotOKButton) {
          ...
          if (this.by === 'created_by' || this.by === 'myself') params.set('by_created', 'true');

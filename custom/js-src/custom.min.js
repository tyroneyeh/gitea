      ...
      methods: {
        ...
        onToggle(target, e) {
          if (target === 'repos') {
            ...
            this.isReposOpen ? localStorage.setItem('report-repos-details-open', e.target.open) : localStorage.removeItem('report-repos-details-open');
          }
          if (target === 'labels') {
            this.isLabelsOpen = e.target.open;
            this.isLabelsOpen ? localStorage.setItem('report-labels-details-open', e.target.open) : localStorage.removeItem('report-labels-details-open');
          }
          if (target === 'users') {
            this.isUsersOpen = e.target.open;
            this.isUsersOpen ? localStorage.setItem('report-users-details-open', e.target.open) : localStorage.removeItem('report-users-details-open');
          }
        },

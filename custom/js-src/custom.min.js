...
function reportGenerator() {
  ...
  loadResource('https://cdn.jsdelivr.net/npm/vue@3/dist/vue.global.prod.js', () => {
    ...
    const columns = [
      ...
      {name: 'Title', sort: true, attributes: {style: 'width:50%', class: 'gridjs-td tw-whitespace-nowrap ellipsis'}},
    ...
    function titleControl(endDate) {
      ...
      for (const column of columns) {
        ...
        checkbox.addEventListener('change', (event) => {
          ...
          if (event.target.checked) localStorage.setItem(`report-column-${name}`, '1');
      ...
      mounted() {
        ...
        loadResource('https://cdn.jsdelivr.net/npm/gridjs/dist/gridjs.umd.js', async () => {
          ...
          window.grid.on('cellClick', (cell) => {
            ...
            target.classList.toggle('tw-overflow-x-scroll');
          });

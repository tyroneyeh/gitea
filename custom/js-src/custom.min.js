  ...
  loadResource('https://cdn.jsdelivr.net/npm/vue@3/dist/vue.global.prod.js', () => {
    ...
    window.app = createApp({
      ...
      watch: {
        ...
        by(newValue) {
          if (window.isRD && newValue === 'assigned_by' || newValue === 'created_by') localStorage.removeItem('report-by');
      ...
      methods: {
        dateCtrl(day, e) {
          const quickDayBtn = document.querySelectorAll('#quickdaybtn input');
          for (const btn of quickDayBtn) {
      ...
      mounted() {
        ...
        loadResource('https://cdn.jsdelivr.net/npm/gridjs/dist/gridjs.umd.js', async () => {
          const columns = [
            ...
            {name: 'Repos.#ID', sort: {compare: (a, b) => a.props.content.replace(/<[^>]*>?/gm, '').localeCompare(b.props.content.replace(/<[^>]*>?/gm, ''))}, attributes: {style: 'width:auto;white-space:nowrap'}},

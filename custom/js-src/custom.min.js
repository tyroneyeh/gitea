    ...
    window.app = createApp({
        ...
        async queryReport(e) {
          ...
          for (const issue of resData || []) {
            ...
            if (this.by === 'myself') {
              ...
              const lastCommentBody = comm.length ? cleanCellText(comm[comm.length - 1].body) : '';
              ...
              data[data.length - 1].push(commentText.trim());
            }
          }
      ...
      mounted() {
        ...
        loadResource('https://cdn.jsdelivr.net/npm/gridjs/dist/gridjs.umd.js', async () => {
          ...
          window.grid.on('cellClick', (row) => {
            row.target.style.overflow = '';
            row.target.style.overflowX = 'auto';
            row.target.style.textOverflow = '';
          });

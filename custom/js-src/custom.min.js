      ...
      methods: {
        ...
        async queryReport(e) {
          ...
          if (this.by === 'myself') {
            ...
            commData = commData.filter((v) => v.user.username === this.username);
          }
          ...
          for (const issue of resData) {
            ...
            if ((this.userTitle.length && (this.by === 'assigned_by' && !issue.assignees?.some((a) => a.full_name.startsWith(this.userTitle))) ||
              ...
              (this.userTitle.length && this.by === 'myself' && commData.find((c) => this.username === c.user.username && issue.html_url === c.issue_url) === undefined)) {
              continue;
            }

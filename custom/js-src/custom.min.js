...
function reportGenerator() {
  ...
  loadResource('https://cdn.jsdelivr.net/npm/vue@3/dist/vue.global.prod.js', () => {
    ...
    const columns = [
      ...
      {name: 'Assignee', sort: true, hidden: true, attributes: {style: 'width:190px', class: 'gridjs-td ellipsis'}},
      ...
      methods: {
        ...
        async queryReport(e) {
          ...
          for (const issue of resData || []) {
            ...
            const repoName = issue.repository.full_name;
            reposSummaryData[repoName] = reposSummaryData[repoName] || {issueCount: 0, openCount: 0, closedCount: 0};
            reposSummaryData[repoName].issueCount++;
            this.reposSummary = reposSummaryData;
            issue.state === 'open' ? reposSummaryData[repoName].openCount++ : reposSummaryData[repoName].closedCount++;
          ...
          this.reposSummary = Object.fromEntries(Object.entries(reposSummaryData).sort((a, b) => b[1].issueCount - a[1].issueCount));

...
function addCreatedByListButton() {
  const firstElement = document.querySelector('.first');
  if (!firstElement) return;
  const taskLists = document.querySelectorAll('.first .task-list-item:not(:has(input:checked)) a');
  ...
  const getTaskList = async () => {
    ...
    generateTaskButtonElement.disabled = false;

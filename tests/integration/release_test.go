...
func TestCreateRelease(t *testing.T) {
	...
	checkLatestReleaseAndCount(t, session, "/user2/repo1", "v0.0.1", translation.NewLocale("en-US").TrString("Stable"), 4)
}
...
func TestCreateReleasePreRelease(t *testing.T) {
	...
	checkLatestReleaseAndCount(t, session, "/user2/repo1", "v0.0.1", translation.NewLocale("en-US").TrString("Pre-Release"), 4)
}
...
func TestCreateReleaseDraft(t *testing.T) {
	...
	checkLatestReleaseAndCount(t, session, "/user2/repo1", "v0.0.1", translation.NewLocale("en-US").TrString("Draft"), 4)
}
...
func TestCreateReleasePaging(t *testing.T) {
	...
	checkLatestReleaseAndCount(t, session, "/user2/repo1", "v0.0.12", translation.NewLocale("en-US").TrString("Draft"), 10)

	// Check that user4 does not see draft and still see 10 latest releases
	session2 := loginUser(t, "user4")
	checkLatestReleaseAndCount(t, session2, "/user2/repo1", "v0.0.11", translation.NewLocale("en-US").TrString("Stable"), 10)
}

...
func testCreateBranches(t *testing.T, giteaURL *url.URL) {
	tests := []struct {
	...
	}{
		{
			...
			FlashMessage:   translation.NewLocale("en-US").TrString("Branch \"%s\" has been created.", "feature/test1"),
		},
		{
			OldRefSubURL:   "branch/master",
			NewBranch:      "",
			ExpectedStatus: http.StatusSeeOther,
			FlashMessage:   translation.NewLocale("en-US").TrString("New branch name") + translation.NewLocale("en-US").TrString(" cannot be empty."),
		},
		{
			OldRefSubURL:   "branch/master",
			NewBranch:      "feature=test1",
		...
		},
		{
			...
			ExpectedStatus: http.StatusSeeOther,
			FlashMessage:   translation.NewLocale("en-US").TrString("New branch name") + translation.NewLocale("en-US").TrString(" must contain at most %s characters.", "100"),
		},
		{
			OldRefSubURL:   "branch/master",
			NewBranch:      "master",
			ExpectedStatus: http.StatusSeeOther,
			FlashMessage:   translation.NewLocale("en-US").TrString("Branch \"%s\" already exists in this repository.", "master"),
		},
		{
			OldRefSubURL:   "branch/master",
			NewBranch:      "master/test",
			ExpectedStatus: http.StatusSeeOther,
			FlashMessage:   translation.NewLocale("en-US").TrString("Branch name \"%s\" conflicts with the already existing branch \"%s\".", "master/test", "master"),
		},
		{
		...
		},
		{
			...
			ExpectedStatus: http.StatusSeeOther,
			FlashMessage:   translation.NewLocale("en-US").TrString("Branch \"%s\" has been created.", "feature/test3"),
		},
		{
			OldRefSubURL:   "branch/master",
			NewBranch:      "v1.0.0",
			...
			ExpectedStatus: http.StatusSeeOther,
			FlashMessage:   translation.NewLocale("en-US").TrString("Branch \"%s\" cannot be created as a tag with same name already exists in the repository.", "v1.0.0"),
		},
		{
			...
			ExpectedStatus: http.StatusSeeOther,
			FlashMessage:   translation.NewLocale("en-US").TrString("Branch \"%s\" has been created.", "feature/test4"),
		},
	}
